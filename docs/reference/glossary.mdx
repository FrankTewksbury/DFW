---
title: "Glossary"
description: "Complete DFW terminology reference"
icon: "book-open"
---

A complete reference for all DFW (Development Flywheel) terminology. When you encounter an unfamiliar DFW term, consult this glossary before guessing.
